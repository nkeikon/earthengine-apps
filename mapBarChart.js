...
var area1 = ee.Image("users/nkeikon/myanmar_sr/area1_map"),
    ...
    ee.Geometry.Polygon(
        [[[98.7176912784284, 12.71218198118936],
          [98.7176912784284, 12.63782173153423],
          [98.77365288731512, 12.63782173153423],
          [98.77365288731512, 12.71218198118936]]], null, false);
...
Map.add(chartPanel);
var areaImage = ee.Image.pixelArea().addBands(total).divide(10000);
function chartAreaByClass() {
  ...
  var chart = ui.Chart.image
    ...
    .setSeriesNames(
    labels) //(['Oil palm','Rubber', 'Other trees', 'Shrub', 'Bare', 'Water'])
